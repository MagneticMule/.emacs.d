...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-complete-auctex yasnippet-bundle workgroups window+ web-mode visual-regexp tern-auto-complete term+ sr-speedbar smooth-scrolling smex smartparens shell-history shell-command session projectile powerline-evil pos-tip php-extras php-completion org-ac neotree material-theme markdown-mode+ json-mode js3-mode js2-refactor ido-ubiquitous ido-hacks helm-flymake helm-flycheck helm-bibtexkey helm-bibtex haxe-mode guide-key flymake-jslint flymake-jshint flycheck-tip flycheck-css-colorguard evil-magit evil-leader evil-jumper evil-escape evil-commentary evil-args ecb dash-at-point company-web color-theme-sanityinc-tomorrow color-theme awk-it auctex-latexmk ag ac-python ac-js2 ac-ispell ac-etags ac-emmet)))
